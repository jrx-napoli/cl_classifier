...
def train_classifier(args, models_definition, local_vae, curr_global_decoder, feature_extractor, head, task_id, train_dataset_loader, train_dataset_splits,
                    train_dataset_loader_big, class_table, n_classes, device, binary_head=False, global_benchmark=False):
