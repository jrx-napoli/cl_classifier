...
class CacheClassLabel(data.Dataset):
    ...
    def __init__(self, dataset):
        ...
        label_cache_filename = path.join(dataset.root, str(type(dataset)).split("'")[1] + '_' + str(len(dataset)) +'.pth')
        print(label_cache_filename)
        # label_cache_filename = 'data\\torchvision.datasets.mnist.FashionMNIST_60000.pth'
